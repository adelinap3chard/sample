sap.ui.jsview("TestReports.reports.link.suiteByCycleLink", {

      getControllerName : function() {
         return "TestReports.reports.link.suiteByCycleLink";
      },
      ...
      createContent : function(oController) {
    	   ...
    	   //Create a matrix layout
  	       ...
  	       var oTable = new sap.ui.table.Table({
  	        ...
  	        var linkView = sap.ui.getCore().byId("link_detailResultCycleLink");	//link to open  
	        var oDialog = sap.ui.getCore().byId("linkDialog");
	        var oView = sap.ui.getCore().byId("link_suiteByCycleLink");// this file link 
  	        ...
  	        oTable.addColumn(new sap.ui.table.Column({
  	            ...
  	            template: new sap.ui.commons.Link({
	    		   ...
	    		   press : function(value){
	    			   ...
	    			   linkView.data("my_data", {'cycle': cycle, 'catalog': catalog, 'suite': suite, 'init': false, 'back_id': "link_suiteByCycleLink"});// go back to this file link 
