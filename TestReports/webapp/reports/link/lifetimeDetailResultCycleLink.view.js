sap.ui.jsview("TestReports.reports.link.lifetimeDetailResultCycleLink", {

      getControllerName : function() {
         return "TestReports.reports.link.lifetimeDetailResultCycleLink";
      },
      ...
      createContent : function(oController) {
    	   //Create a matrix layout
  	       ...
  	       var oTable = new sap.ui.table.Table({
   	    	    id: "lifetimeDetailResultCycleLink",
   	    	    //width: "100%",
  	  	   	   	visibleRowCount: 20,
  	       ...
  	       */
  	       ...
  	       var linkView = sap.ui.getCore().byId("link_lifetimeTestCaseLink");      
	       var oDialog = sap.ui.getCore().byId("linkDialog");
	       var oView = sap.ui.getCore().byId("link_lifetimeDetailResultCycleLink");
  	       ...
  	       oTable.addColumn(new sap.ui.table.Column({
  	           ...
  	           template: new sap.ui.commons.Link({
	    		   ...
	    		   press : function(value){
	    			   ...
	    			   linkView.data("my_data", {'cycle': cycle, 'catalog': catalog, 'testCase': testCase, 'init': false, 'back_id': "link_lifetimeDetailResultCycleLink"});
