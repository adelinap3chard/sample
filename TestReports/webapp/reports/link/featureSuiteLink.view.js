sap.ui.jsview("TestReports.reports.link.featureSuiteLink", {

      getControllerName : function() {
         return "TestReports.reports.link.featureSuiteLink";
      },
      ...
      createContent : function(oController) {
    	   ...
    	   //Create a matrix layout
  	       ...
  	       var oTable = new sap.ui.table.DataTable({
  	    	   id : "featureSuiteLinkTable",
  	    	   title : "Summary report byy feature",
 	    	   //width : "100%",
 	    	   visibleRowCount: 20,
 	    	   firstVisibleRow: 3,
	        ...
	        oTable.addColumn(new sap.ui.table.Column({
  	       ...
  	       var oControl = new sap.ui.commons.TextView({
  	        ...
  	        var linkView = sap.ui.getCore().byId("link_lifetimeDetailResultCycleLink");	      
	        var oDialog = sap.ui.getCore().byId("linkDialog");
	        var oView = sap.ui.getCore().byId("link_featureSuiteLink");
  	        ...
  	        oTable.addColumn(new sap.ui.table.Column({
  	            ...
  	            template: new sap.ui.commons.Link({
	    		   ...
	    		   press : function(value){
	    			   ...
	    			   linkView.data("my_data", {'cycle': cycle, 'catalog': catalog, 'suite': suite, 'init': false, 'back_id': "link_featureSuiteLink"}); //link to go back 
