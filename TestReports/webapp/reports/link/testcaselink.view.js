sap.ui.jsview("TestReports.reports.link.testcaselink", {

      getControllerName : function() {
         return "TestReports.reports.link.testcaselink";
      },
    	   ...
    	   //Create a matrix layout
	        ...
	        oTable.addColumn(new sap.ui.table.Column({
  	        ...
  	        var oControl = new sap.ui.commons.TextView({
  				text : "{tc_details}"});
  	        oTable.addColumn(new sap.ui.table.Column({
  	            label : new sap.ui.commons.Label({text : "Test case details"}),
  	            template : oControl,
  	            //width: '500px',
